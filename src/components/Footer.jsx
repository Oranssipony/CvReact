    ...
    return (
       <section className="footer">
            ...
            <div className="footerinfo">
                ...
                <li><a href="Blog"><span className="fleche">{"> "}</span>Coder son site en HTML/CSS</a></li>
                <li><a href="Blog"><span className="fleche">{"> "}</span>Vendre ses produits sur le web</a></li>
                <li><a href="Blog"><span className="fleche">{"> "}</span>Se positionner sur Google</a></li>   
            </div>
